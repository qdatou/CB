...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"Next",sPrevious:"Previous"},sEmptyTable:"没有数据可用于显示。",sInfo:"显示从第 _START_ 行到第 _END_ 行 总行数： _TOTAL_",sInfoEmpty:"显示从第 0 行到第 0 行 总行数： 0 ",sInfoFiltered:"(从 _MAX_ 条中过滤出)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Search:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"没有数据可用于显示"},oSearch:h.extend({},
